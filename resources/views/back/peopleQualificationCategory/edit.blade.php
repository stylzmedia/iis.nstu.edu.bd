                    ...
                    <div class="row">
                            ...
                            <div class="card border-light mt-3 shadow">
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-bordered table-sm" id="dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($qualification_categories as $category)
                                                <tr>
                                                    <th scope="row">{{ $category->id }}</th>
                                                    <td>
                                                        {{ $category->PeopleQualification->title }}
                                                    </td>
                                                    <td>
                                                        {{ $category->title }}
                                                    </td>
                        ...
                        <div class="col-md-4">
                            <div class="card border-light mt-3 shadow">
                                ...
                                <form
                                    action="{{ route('back.people-qualification-category.update', $peopleQualificationCategory->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title"
                                                        value="{{ old('title') ?? $peopleQualificationCategory->title }}"
                                                        required>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="people_qualification_id" id="">
                                                        ...
                                                        @foreach ($people_qualifications as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ $peopleQualificationCategory->people_qualification_id == $item->id ? 'selected' : '' }}>
                                                                {{ $item->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="position"
                                                        value="{{ old('position') ?? $peopleQualificationCategory->position }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
