...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
                            ...
                            <tbody>
                                @foreach ($galleries as $gallery)
                                    <tr>
                                        ...
                                        <td>
                                            @isset(auth()->user()->role->permission['permission']['galleries']['edit'])
                                            <a href="{{route('back.galleries.edit', $gallery->id)}}"><i class="ri-edit-2-line"></i></a>
                                            @endisset
                                            ||
                                            @isset(auth()->user()->role->permission['permission']['galleries']['delete'])
            ...
            @isset(auth()->user()->role->permission['permission']['galleries']['add'])
            <div class="col-md-4">
                <div class="card border-light mt-3 shadow">
