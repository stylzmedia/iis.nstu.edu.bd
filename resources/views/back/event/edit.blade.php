                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                <label for="location_address" class="form-label">Location
                                                    Address</label>
                                                <textarea name="location_address" class="form-control" id="location_address" cols=""
                                                    rows="4">{{ old('location_address') ?? $event->location_address }}</textarea>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label for="location_map" class="form-label">Location Map</label>
                                                <textarea name="location_map" class="form-control" id="location_map" cols=""
                                                    rows="4">{{ old('location_map') ?? $event->location_map }}</textarea>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="meta_tags"
                                                    value="{{ old('meta_tags') ?? $event->meta_tags }}">
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" class="form-control" id="meta_description" cols=""
                                                    rows="5">{{ old('meta_description') ?? $event->meta_description }}</textarea>
                                            </div>
                                            <br>
