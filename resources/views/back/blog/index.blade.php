            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="blog-table-header card-header">
                        ...
                        <a href="{{route('back.blogs.create')}}" class="btn btn-info float-right"><i class="ri-add-circle-line"></i> Create New</a>
                    </div><!-- end card header -->
                            ...
                            <tbody>
                                @foreach ($blogs as $key => $blog)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-sm btn-success" href="{{route('back.blogs.edit', $blog->id)}}"><i class="ri-edit-2-line"></i></a>
