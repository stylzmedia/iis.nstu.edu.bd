                                    ...
                                    <div class="row live-preview">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="img_group">
                                                ...
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="text-left ft_video form-group" style="display: none">
                                                        <input type="text" class="form-control feature_video" name="feature_video">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="file" name="video" accept="video/*" class="video_input form-control mt-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="exampleInputdate" name="publish_date">
                                            </div>
                                            <br>
                                            <div class="col-12">
