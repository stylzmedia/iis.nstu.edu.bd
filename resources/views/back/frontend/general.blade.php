                                        ...
                                        <div class="row">
                                            ...
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade show active" id="v-pills-WebInfo" role="tabpanel" aria-labelledby="v-pills-WebInfo-tab">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label"><b>Number*: </b></label>
                                                        <div class="col-sm-8">
                                                            <input type="number" class="form-control" placeholder="Mobile Number" name="mobile_number" value="{{$settings_g['mobile_number'] ?? ''}}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="number" class="form-control" placeholder="Tel" name="tel" value="{{$settings_g['tel'] ?? ''}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
