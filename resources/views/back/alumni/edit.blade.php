                ...
                <div class="col-xxl-12">
                    ...
                    <div class="row">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('back.alumni.update', $alumni->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row live-preview">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="name" value="{{old('name') ?? $alumni->name}}" required>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="sub_title" name="designation" value="{{old('designation') ?? $alumni->designation}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="sub_title" name="batch_no" value="{{old('batch_no') ?? $alumni->batch_no}}">
                                                    </div>
                                                </div>
                                            </div>
